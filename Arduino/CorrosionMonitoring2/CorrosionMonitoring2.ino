...
//staple(positive_relay_pin, sensor_relay_pin, sensor_pin, indicator_pin, break_limit)
  staple staple1(A3,A3,A0,A1,5,1022);//Each relay has two switches and that is why we can use the same pin for both positive pin and relay pin of each staple.
  staple staple2(A2,A2,A0,A1,6,1022);
  staple staple3(2,2,A0,A1,7,1022);
  staple staple4(3,3,A0,A1,8,1022); //pins 10,11,12,13 are used for SPI, pins A4,A5 are used for I2C
